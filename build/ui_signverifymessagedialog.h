...
public:
    ...
    void retranslateUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        infoLabel_SM->setText(QApplication::translate("SignVerifyMessageDialog", "You can sign messages with your addresses to prove you own them. Don't sign messages that others can use to impersonate you.", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        addressIn_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The address to sign the message with (e.g. TXbZLDSd6EQ5aR3bwjys3sA17FuFS4uLB6)", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this WinnerCoin address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        ...
        infoLabel_VM->setText(QApplication::translate("SignVerifyMessageDialog", "Enter the signing address, message (ensure you copy line breaks, spaces, tabs, etc. exactly) and signature below to verify the message. If the message verifies, then it only means that the message was signed by the owner of the address it is signed with. It does not mean that the person who sent you the signed message is the owner of the address.", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        addressIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The address the message was signed with (e.g. TXbZLDSd6EQ5aR3bwjys3sA17FuFS4uLB6)", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified WinnerCoin address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
