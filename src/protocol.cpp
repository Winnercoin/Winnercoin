...
static unsigned char pchMessageStartTest[4] = { 0xab, 0xb1, 0xb5, 0xda };

// WinnerCoin message start (unique)
static unsigned char pchMessageStartLitecoin[4] = { 0xbf, 0xc1, 0xb7, 0xad };
