#############################################################################
# Makefile for building: WinnerCoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: di 17. nov 00:33:11 2015
# Project:  winnercoin-qt.pro
# Template: app
# Command: c:/Qt/4.8.6/bin/qmake.exe USE_QRCODE=- USE_UPNP=- USE_IPV6=1 -o Makefile winnercoin-qt.pro
#############################################################################
...
Makefile: winnercoin-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=- USE_UPNP=- USE_IPV6=1 -o Makefile winnercoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/winnercoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/winnercoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/winnercoin/src/leveldb/libleveldb.a: FORCE
